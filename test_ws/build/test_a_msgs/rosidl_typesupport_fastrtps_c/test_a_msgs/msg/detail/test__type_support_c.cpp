...
#include "test_a_msgs/msg/detail/test__rosidl_typesupport_fastrtps_c.h"
...
#include "test_a_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_test_a_msgs
...
using _Test__ros_msg_type = test_a_msgs__msg__Test;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_a_msgs
size_t get_serialized_size_test_a_msgs__msg__Test(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Test__ros_msg_type * ros_message = static_cast<const _Test__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Test__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_a_msgs__msg__Test(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_a_msgs
size_t max_serialized_size_test_a_msgs__msg__Test(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_a_msgs__msg__Test;
    is_plain =
      (
...
static size_t _Test__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_a_msgs__msg__Test(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_a_msgs, msg, Test)() {
