...
#include "test_a_msgs/msg/detail/test__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_a_msgs::msg::Test;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const test_a_msgs::msg::Test *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_a_msgs::msg::Test *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_test_a_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<test_a_msgs::msg::Test>()
{
  return &test_a_msgs::msg::typesupport_fastrtps_cpp::_Test__handle;
}
