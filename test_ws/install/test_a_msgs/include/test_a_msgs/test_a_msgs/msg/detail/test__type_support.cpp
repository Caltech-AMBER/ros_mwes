...
{
  new (message_memory) test_a_msgs::msg::Test(_init);
}

void Test_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_a_msgs::msg::Test *>(message_memory);
  typed_message->~Test();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_message_member_array[1] = {
  {
    ...
    offsetof(test_a_msgs::msg::Test, header),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_message_members = {
  "test_a_msgs::msg",  // message namespace
  "Test",  // message name
  1,  // number of fields
  sizeof(test_a_msgs::msg::Test),
...
{
  return &::test_a_msgs::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_a_msgs, msg, Test)() {
  return &::test_a_msgs::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
